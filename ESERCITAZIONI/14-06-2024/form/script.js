...
buttonSendEl.addEventListener('click', async e => {
  ...
  const newProduct = {
    ...
    //separo i link delle immagini divisi dalle virgole e costruisco l'array
  ...
  titleElement.textContent = "Prodotto caricato correttamente";

  divMessage.append(titleElement);
})
...
//funzione per caricare i dati  (richiesta GET)
